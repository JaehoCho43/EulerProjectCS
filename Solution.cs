...
namespace ProjectEuler
{
	...
	public class Problem13 : Problem
	{
		...
		public override string Solve()
		{
			...
			return long.Parse(sum.ToString().Substring(0, 10)).ToString();
		}
	}
	...
	public class Problem22 : Problem
    {
		...
		public override string Solve()
		{
			int NameScore(string name) => name.Select(ch => ch - 'A' + 1).Sum();
	...
	public class Problem23 : Problem
    {
		...
		public override string Solve()
		{
			bool IsAbundantNumber(int n) => Enumerable.Range(1,n-1).Where(d => n%d == 0).Sum() > n;
